...
@router.get("/{collection_id}/archive", dependencies=[Depends(uds_api_authorize)])
@router.get("/{collection_id}/archive/", dependencies=[Depends(uds_api_authorize)])
...
@router.put("/{collection_id}/archive/{granule_id}", dependencies=[Depends(uds_api_authorize)])
@router.put("/{collection_id}/archive/{granule_id}/", dependencies=[Depends(uds_api_authorize)])
