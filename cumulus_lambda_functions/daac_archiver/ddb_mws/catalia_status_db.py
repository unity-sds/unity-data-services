...
class CataliaStatusDb:
    ...
    def add(self, identifier: str, collection: dict, name_str: str, status: str, datetime_str: str, error_code: str=None, error_message: str=None, href_str: str=None, target_collection: str=None):
        item1 = {
